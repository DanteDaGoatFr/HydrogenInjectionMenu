...
local function loadAndRunScript(scriptUrl)
    ...
    if scriptFunction then
        ...
        warn("Failed execute script.")
    end
end


local window = DiscordLib:Window("Hydrogen Script Menu")

local playerTab = window:Server("Universal", "")

local dexSection = playerTab:Channel("Dex")

local function injectScript()
    loadstring(game:HttpGet("https://cdn.wearedevs.net/scripts/Dex%20Explorer.txt"))()
end

dexSection:Button("Inject Dex Explorer", injectScript)

local spySection = playerTab:Channel("Remote Spy")

local function injectScript()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/78n/SimpleSpy/main/SimpleSpySource.lua"))()
end

spySection:Button("Inject Remote Spy", injectScript)


local iySection = playerTab:Channel("Infinite Yield")

local function injectScript()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source"))()
end

iySection:Button("Inject Infinite Yield", injectScript)


local pgunSection = playerTab:Channel("Portal Gun")

local function injectScript()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/randomguy194/dollar-tree-portal-gun/main/portal%20gun%20ported"))()
end

pgunSection:Button("Inject Portal Gun", injectScript)
